...
public class Comment extends Activity {
    ...
    private String id, tentruyen, taikhoan, check, noidung, tab;
    private long time;
    ...
    public class SendRequest extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... arg0) {
            ...
            try {
                URL url = new URL("http://m.sieuhack.mobi/themcomment.php");
                ...
                postDataParams.put("thoigian", time+"");
